# Missouri — Poll Worker Guides & Training Materials

Official poll-worker manuals and training resources for Missouri, compiled for the VB Election Desk knowledge base from 'Pollworker Guides.xlsx'.

## Missouri Secretary of State — Poll Worker FAQs
...
Election Poll Workers Frequently Asked Questions (FAQs)

Q:

How do I sign up to be a poll worker?

A: The Missouri Secretary of State’s office is partnering with businesses, academic institutions and civic and labor groups around the state to help local election authorities recruit additional poll workers for the 2022 elections. 
...
What does a poll worker or election judge do?
...
Are poll workers and elections judges paid?/span>
...
Are poll workers and election judges required to declare a political party?
...
I don’t consider myself a Democrat or a Republican. Can I still be a poll worker?
...
How will I learn what duties are expected of me on Election Day?
...
Q: 
Is my work complete when the polls close?
...
What if I can only work half of the day?
...
Do I have to take a vacation day from work to serve as a poll worker?
...
Will I be assigned to work at the place I normally vote?

A. Not necessarily. Your local election authority will determine where you are needed to work on Election Day.

Q: 
How can I cast my ballot if I am not working at my regular polling place?

A. Many poll workers cast their ballot by voting absentee since they will be working on Election Day. Speak with your local election authority to ensure that you are able to cast your ballot. We want to ensure that you can vote 
as well as
 serve as a poll worker on Election Day.

Q:

Do I have to know how to use a computer to be a poll worker?
...
Q: 
Is there an age requirement for serving as a poll worker?
